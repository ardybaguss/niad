(function ($) {
  ...
  function go_getAutoObject(a, b) {
    return (
      ...
      is_jquery(b) ? (b = { button: b }) : is_boolean(b) ? (b = { play: b }) : is_number(b) && (b = { timeoutDuration: b }),
      b.progress && (is_string(b.progress) || is_jquery(b.progress)) && (b.progress = { bar: b.progress }),
      b
    );
  }
  function go_complementAutoObject(a, b) {
    return (
      ...
      b.progress &&
        (is_function(b.progress.bar) && (b.progress.bar = b.progress.bar.call(a)),
        is_string(b.progress.bar) && (b.progress.bar = $(b.progress.bar)),
        b.progress.bar ? (is_function(b.progress.updater) || (b.progress.updater = $.fn.carouFredSel.progressbarUpdater), is_number(b.progress.interval) || (b.progress.interval = 50)) : (b.progress = !1)),
      b
    );
  }
  ...
  function gn_getItemIndex(a, b, c, d, e) {
    if (
      (is_string(a) && (a = $(a, e)),
      is_object(a) && (a = $(a, e)),
      is_jquery(a) ? ((a = e.children().index(a)), is_boolean(c) || (c = !1)) : is_boolean(c) || (c = !0),
      is_number(a) || (a = 0),
      is_number(b) || (b = 0),
      c && (a += d.first),
      (a += b),
  ...
  function in_complementItems(a, b, c, d) {
    return (
      ...
      is_object(a.visible)
        ...
        : is_string(a.visible)
        ? ("variable" == a.visible ? (a.visibleConf.variable = !0) : (a.visibleConf.adjust = a.visible), (a.visible = !1))
        : is_function(a.visible) && ((a.visibleConf.adjust = a.visible), (a.visible = !1)),
      is_string(a.filter) || (a.filter = c.filter(":hidden").length > 0 ? ":visible" : "*"),
      a[b.d.width] ||
        (b.responsive ? (debug(!0, "Set a " + b.d.width + " for the items!"), (a[b.d.width] = ms_getTrueLargestSize(c, b, "outerWidth"))) : (a[b.d.width] = ms_hasVariableSizes(c, b, "outerWidth") ? "variable" : c[b.d.outerWidth](!0))),
    ...
    return (
      ...
      a.items.visibleConf.variable ||
        (is_number(a[a.d.width])
          ...
          : ((a.items.visible = Math.floor(b / a.items[a.d.width])), (a[a.d.width] = a.items.visible * a.items[a.d.width]), a.items.visibleConf.adjust || (a.align = !1)),
        ("Infinity" == a.items.visible || 1 > a.items.visible) && (debug(!0, 'Not a valid number of visible items: Set to "variable".'), (a.items.visibleConf.variable = !0))),
      a
    );
  }
  ...
  $.fn.carouFredSel ||
    (($.fn.caroufredsel = $.fn.carouFredSel =
      function (options, configs) {
        ...
        (FN._init = function (a, b, c) {
          ...
          if (
            ...
            is_percentage(opts[opts.d.width]) &&
              ((crsl.upDateOnWindowResize = !0), (crsl.primarySizePercentage = opts[opts.d.width]), (opts[opts.d.width] = ms_getPercentage(e, crsl.primarySizePercentage)), opts.items.visible || (opts.items.visibleConf.variable = !0)),
            opts.responsive
              ? ((opts.usePadding = !1), (opts.padding = [0, 0, 0, 0]), (opts.align = !1), (opts.items.visibleConf.variable = !1))
              : (opts.items.visible || (opts = in_complementVisibleItems(opts, e)),
                opts[opts.d.width] ||
                  (!opts.items.visibleConf.variable && is_number(opts.items[opts.d.width]) && "*" == opts.items.filter
            ...
            "*" == opts.items.filter || opts.items.visibleConf.variable || ((opts.items.visibleConf.org = opts.items.visible), (opts.items.visible = gn_getVisibleItemsNextFilter(d, opts, 0))),
          ...
          (FN._bind_events = function () {
            FN._unbind_events(),
              $cfs.bind(cf_e("stop", conf), function (a, b) {
                return (
                  a.stopPropagation(), crsl.isStopped || (opts.auto.button && opts.auto.button.addClass(cf_c("stopped", conf))), (crsl.isStopped = !0), opts.auto.play && ((opts.auto.play = !1), $cfs.trigger(cf_e("pause", conf), b)), !0
                );
              }),
              ...
              $cfs.bind(cf_e("pause", conf), function (a, b, c) {
                ...
                if (
                  (crsl.isPaused || crsl.isScrolling || (c && (tmrs.timePassed += getTime() - tmrs.startTime)),
              ...
              $cfs.bind(cf_e("prev", conf) + " " + cf_e("next", conf), function (a, b, c, d, e) {
                ...
                if (b.duration > 0 && crsl.isScrolling)
                  return (
                    b.queue && ("last" == b.queue && (queu = []), ("first" != b.queue || 0 == queu.length) && $cfs.trigger(cf_e("queue", conf), [j, [b, c, d]])), a.stopImmediatePropagation(), debug(conf, "Carousel currently scrolling.")
                  );
              ...
              $cfs.bind(cf_e("slide_prev", conf), function (a, b, c) {
                ...
                if (
                  ...
                  ("variable" == opts[opts.d.width] || "variable" == opts[opts.d.height]) &&
                    ((E = function () {
                      $wrp.css(u);
                    }),
                    (F = function () {
                  ...
                  k.not(j).length &&
                    ...
                    m >= 0 &&
                      ((A[opts.d.marginRight] = k.data("_cfs_origCssMargin") + opts.padding[opts.d[1]]),
                      (I = function () {
                        k.css(A);
                      }),
                      (J = function () {
              ...
              $cfs.bind(cf_e("insertItem", conf), function (a, b, c, d, e) {
                ...
                "end" == c
                  ? d
                    ? (0 == itms.first ? ((c = itms.total - 1), (j = "after")) : ((c = itms.first), (itms.first += b.length)), 0 > c && (c = 0))
                    : ((c = itms.total - 1), (j = "after"))
                  : (c = gn_getItemIndex(c, e, d, itms, $cfs));
                var k = $cfs.children().eq(c);
                return (
                  k.length ? k[j](b) : (debug(conf, "Correct insert-position not found! Appending item to the end."), $cfs.append(b)),
              ...
              $cfs.bind(cf_e("updateSizes", conf), function () {
                ...
                if (
                  ((itms.total = c.length),
                  crsl.primarySizePercentage ? ((opts.maxDimension = d), (opts[opts.d.width] = ms_getPercentage(d, crsl.primarySizePercentage))) : (opts.maxDimension = ms_getMaxDimension(opts, d)),
                  opts.responsive
                    ? ((opts.items.width = opts.items.sizesConf.width), (opts.items.height = opts.items.sizesConf.height), (opts = in_getResponsiveValues(opts, c, d)), (b = opts.items.visible), sz_setResponsiveSizes(opts, c))
                    : opts.items.visibleConf.variable
                    ? (b = gn_getVisibleItemsNext(c, opts, 0))
                    : "*" != opts.items.filter && (b = gn_getVisibleItemsNextFilter(c, opts, 0)),
          ...
          (FN._bind_buttons = function () {
            ...
            if (
              (opts.auto.button &&
                opts.auto.button.bind(cf_e(opts.auto.event, conf, !1), function (a) {
                  a.preventDefault();
                  var b = !1,
                    c = null;
              ...
              opts.prev.button &&
                (opts.prev.button.bind(cf_e(opts.prev.event, conf, !1), function (a) {
            ...
            if (
              opts.next.button &&
              (opts.next.button.bind(cf_e(opts.next.event, conf, !1), function (a) {
        ...
        return (
          opts.onCreate && opts.onCreate.call($tt0, { width: siz.width, height: siz.height, items: itm }),
    ...
    ($.fn.carouFredSel.defaults = { synchronise: !1, infinite: !0, circular: !0, responsive: !1, direction: "left", items: { start: 0 }, scroll: { easing: "swing", duration: 500, pauseOnHover: !1, event: "click", queue: !1 } }),
    ($.fn.carouFredSel.configs = { debug: !1, transition: !1, onWindowResize: "throttle", events: { prefix: "", namespace: "cfs" }, wrapper: { element: "div", classname: "caroufredsel_wrapper" }, classnames: {} }),
